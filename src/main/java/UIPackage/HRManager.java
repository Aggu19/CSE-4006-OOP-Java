...
File myFile;
    ...
    private void initComponents() {
        ...
        jLabel13.setText("HR Manager Log In");
       ...
       try{
            ...
            while(null!= (FindLine = bReader.readLine())){
                ...
                if (UserName.equals(uName) && UserPass.equals(uPass)){
                    valid = true;
                    //break outerLoop;
                    JOptionPane.showMessageDialog(null, "Valid Login! "+"HR Manager");
            ...
            if(!valid){
                    JOptionPane.showMessageDialog(null, "Password/Username Mismatch!","Error",JOptionPane.ERROR_MESSAGE);
               }
            fReader.close();
            bReader.close();
        }                        
